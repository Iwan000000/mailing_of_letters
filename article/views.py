...
class ArticleListView(ListView):
    ...
    def get_queryset(self):
        """
        Проверка разрешения (article.change_article).
        Если у пользователя есть разрешение - он получит все статьи.
        Для остальных пользователей - только опубликованные статьи.
        """
        if CACHE_ENABLED:
            key = 'article_list'
